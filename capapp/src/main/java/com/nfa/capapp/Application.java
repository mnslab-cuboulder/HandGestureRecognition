package com.nfa.capapp;

import com.nfa.capapp.config.Constants;
import com.nfa.capapp.config.JHipsterProperties;
...
@ComponentScan
@ImportResource(value = {"classpath:capAppContext.xml"})
...
public class Application {
    ...
    public static void main(String[] args) throws UnknownHostException {
    	...
    	// set headless state to false graphical environment not needed
